...
class SyntaxHighlighterStyle {
  SyntaxHighlighterStyle(
      {this.baseStyle, this.numberStyle, this.commentStyle, this.keywordStyle, this.stringStyle, this.punctuationStyle, this.classStyle, this.constantStyle});
  ...
  static SyntaxHighlighterStyle darkThemeStyle() {
    const orangeColor = const Color(0xFFCC7832);
    const whiteColor = const Color(0xFFA9B7C6);

    return SyntaxHighlighterStyle(
        baseStyle: const TextStyle(color: whiteColor),
        numberStyle: const TextStyle(color: const Color(0xFF1565C0)),
        commentStyle: const TextStyle(color: const Color(0xFF808080)),
        keywordStyle: const TextStyle(color: orangeColor),
        stringStyle: const TextStyle(color: const Color(0xFF6A8759)),
        punctuationStyle: const TextStyle(color: orangeColor),
        classStyle: const TextStyle(color: const Color(0xFF9876AA)),
        constantStyle: const TextStyle(color: orangeColor));
  }
